...
# Añadir el directorio raíz al path para poder importar los módulos hermanos
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

import pandas as pd
from config import MIN_CONFLUENCIAS, CAPITAL_INICIAL, RIESGO_POR_OPERACION

from indicadores.medias_moviles import calcular_emas
...
from indicadores.volumen        import calcular_volumen_medio

from patrones.velas             import detectar_patron
from estrategia.confluencias    import contar_confluencias
from riesgo.gestion             import calcular_gestion_riesgo
