...
# =============================================================================
# MÓDULO: EJECUCIÓN DE ÓRDENES EN ALPACA
# =============================================================================
import os
...
def obtener_cuenta():
    ...
    return {
        ...
        'pl': float(account.total_profit_loss),
        'pl_abierto': float(account.unrealized_intraday_pl),
        'margen_libre': float(account.buying_power),
        'posiciones': 0, # Se llena luego con api.list_positions()
        'trades_abiertos': 0,
